...
Deploy your application online to any provider: Digital Ocean, AWS, Heroku or whatever you're comfortable with.
...
- GitHub link to the code of your assignment
- Link where your application is live